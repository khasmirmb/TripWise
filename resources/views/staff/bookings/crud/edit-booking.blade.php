                    ...
                    <div class="px-4 py-2 mx-auto">
                        <div class="w-full mb-2">
                            <div class="relative overflow-x-auto sm:rounded-lg">
                                <div class="flex-row items-center justify-start p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="bg-slate-100 dark:bg-gray-900 border-b dark:border-gray-700">
                                            ...
                                            <td class="px-6 py-4 flex justify-center space-x-2">
                                                <button type="button" data-modal-target="change_seat-{{$passenger->id}}" data-modal-toggle="change_seat-{{$passenger->id}}" class="font-medium text-teal-600 dark:text-teal-500 hover:underline">Change Seat</button>
                                            </td>
                                        </tr>

                                        @include('staff.bookings.passengers.change-seat')
                        ...
                        <form action="{{route('staff.booking.edit-process' , ['booking' => $booking->id])}}" method="POST">
                            @csrf
                            ...
                            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6 mb-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <select id="payment-method" name="payment-method" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500">
                                        <option value="" disabled>Choose a Type</option>
                                        <option value="otc" {{ old('payment-method', $booking->payment->payment_method) == 'OTC' ? 'selected' : '' }}>OTC</option>
                                        <option value="gcash" {{ old('payment-method', $booking->payment->payment_method) == 'Gcash' ? 'selected' : '' }}>Gcash</option>
                                        <option value="paymaya" {{ old('payment-method', $booking->payment->payment_method) == 'Paymaya' ? 'selected' : '' }}>Paymaya</option>
                                        <option value="card" {{ old('payment-method', $booking->payment->payment_method) == 'Card' ? 'selected' : '' }}>Card</option>
                                        <option value="grab_pay" {{ old('payment-method', $booking->payment->payment_method) == 'Grab_pay' ? 'selected' : '' }}>Grab Pay</option>
                                    </select>
