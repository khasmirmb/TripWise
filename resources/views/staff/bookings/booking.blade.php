        ...
        <div class="rounded-lg mb-4 shadow-md">
            <div class="relative bg-white dark:bg-gray-800 rounded-t-lg">
                ...
                <div class="w-full md:w-1/2">
                    <form action="{{route('staff.booking.search')}}" method="GET" class="flex items-center">
                ...
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    <a href="{{route('staff.booking.add')}}" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 focus:outline-none dark:focus:ring-teal-800">
            ...
            <div class="block overflow-x-auto bg-white dark:bg-gray-800">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg">
                    ...
                    <tbody>
                            ...
                            <td class="px-6 py-3 text-center">
                                ...
                                <div id="booking-action{{$booking->id}}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="booking-action{{$booking->id}}-button">
                                        <li>
                                            <a href="{{route('staff.booking.edit' , ['booking' => $booking->id])}}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                        ...
                                        <li>
                                            <a href="{{ route('staff.generate.pdf', ['payment' => $booking->payment->id, 'contact' => $booking->contactPerson->id, 'booking' => $booking->id]) }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-teal-500 dark:hover:text-teal-400">
                        ...
                        @include('staff.bookings.crud.read-booking')
