@include('partials.header')
    ...
    @include('layouts.itinerary-payment')
    ...
    <section class="bg-white dark:bg-gray-800">
        <div class="grid w-full lg:px-8 lg:grid-cols-2 lg:py-8 px-4 py-4">
            <div class="px-4 pt-8">
              <p class="ml-2 text-xl font-medium text-gray-700 dark:text-white">Booking Summary</p>
            ...
            <div class="px-4 pt-8">
              <p class="ml-2 text-xl font-medium text-gray-700 dark:text-white">Payment Details</p>
              <p class="ml-2 text-gray-400">Complete your booking by providing your payment details.</p>
                <div class="mt-8 mb-1 border bg-white border-gray-300 dark:bg-gray-700 dark:border-0 rounded-xl p-5">
                    ...
                    <div class="relative">
                        <label for="input-group-1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Card Holder</label>
                        <div class="relative mb-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500 dark:text-gray-400">
                        ...
                        <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Your full name here">
                        </div>
                    </div>
                    <label for="input-group-1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Card Details</label>
                    <div class="flex">
                    <div class="relative w-7/12 flex-shrink-0">
                        ...
                        <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="xxxx-xxxx-xxxx-xxxx">
                    </div>
                    <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-2/6 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="MM/YY" required>

                    <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-2/6 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="CVC" required>
                    </div>
                    ...
                    <div class="mt-6 border-t border-b py-2">
                        <div class="flex items-center justify-between">
                            ...
                            <p class="font-semibold text-gray-900 dark:text-white">₱399.00</p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Discount</p>
                            <p class="font-semibold text-gray-900 dark:text-white">₱16.00</p>
                        </div>
                        <div class="flex items-center justify-between">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Online Tax</p>
                            <p class="font-semibold text-gray-900 dark:text-white">₱8.00</p>
                        </div>
                    </div>
                    <div class="mt-6 flex items-center justify-between border-b py-2 mb-5">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white">₱408.00</p>
                    </div>
                    <p class="text-xl font-semibold mb-2 text-gray-700 dark:text-white">Payment Methods:</p>
                    <div class="grid grid-cols-1 gap-1 payment method">
                        <div class="w-full">
                            <button type="button" class="w-full text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:outline-none focus:ring-[#F7BE38]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#F7BE38]/50 mr-2 mb-2">
                        ...
                        <div class="w-full">
                            <button type="button" class="w-full text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 mr-2 mb-2">
                        ...
                        <div class="w-full">
                            <button type="button" class="w-full text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2">
