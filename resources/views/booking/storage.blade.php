    ...
    <div class="mx-4 p-4 mb-4">
        <div class="flex items-center">
            ...
            <div class="flex items-center text-white relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600 hidden sm:block">Account</div>
            </div>
            ...
            <div class="flex items-center text-gray-500 relative">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-gray-500 hidden sm:block">Message</div>
            </div>
            <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-gray-300"></div>
            <div class="flex items-center text-gray-500 relative">
                <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
                ...
                <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-gray-500 hidden sm:block">Confirm</div>
            </div>
        </div>
    </div>
</div> 