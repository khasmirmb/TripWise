        ...
        <footer class="flex flex-col items-center bg-gray-100 text-center text-white dark:bg-gray-700 w-full mt-auto">
            <div class="container pt-9">
                <div class="mb-9 flex justify-center">
                    ...
                    <a href="{{ $url }}" class="sm:mr-9 mr-4 text-neutral-800 dark:text-neutral-200" target="_blank" rel="noopener noreferrer">
                        @if($name === 'facebook')
            ...
            <!--Copyright section-->
            <div class="w-full bg-white p-4 text-center text-neutral-700 dark:bg-gray-800 dark:text-neutral-200">
                © 2023 Copyright:
                <a class="text-teal-800 dark:text-teal-400" href="#">{{ config('app.name', 'Laravel') }}</a>
            </div>
        </footer>
        <!--Slick JS-->
