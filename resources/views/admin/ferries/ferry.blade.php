        ...
        <div class="rounded-lg mb-4">
            <div class="relative bg-white dark:bg-gray-800 rounded-t-lg">
                ...
                <div class="w-full md:w-1/2">
                    <form action="{{route('admin.ferry.search')}}" method="GET" class="flex items-center">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" name="query" id="simple-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-teal-500 focus:border-teal-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500" placeholder="Search for a ferry">
                    </div>
                    </form>
                </div>
                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                    <a href="{{route('admin.ferry.add')}}" class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 focus:outline-none dark:focus:ring-teal-800">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="w-40 p-4">
                                @if ($ferry->image)
                                    <img class="rounded-lg" src="{{asset('ferries/' . $ferry->image)}}" alt="Ferry Image">
                                @else
                                    <img class="rounded-lg" src="{{asset('ferries/default.png')}}" alt="Ferry Image">
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-3 text-center">
                                ...
                                <button id="ferry-action{{$ferry->id}}-dropdown-button" data-dropdown-toggle="ferry-action{{$ferry->id}}-dropdown" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-700 p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                                </div>
                                <div id="ferry-action{{$ferry->id}}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="ferry-action{{$ferry->id}}-dropdown-button">
                                        <li>
                                            <a href="{{route('admin.ferry.edit', ['ferry' => $ferry->id])}}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                        ...
                                        <li>
                                            <button type="button" data-modal-target="read-ferry{{$ferry->id}}" data-modal-toggle="read-ferry{{$ferry->id}}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        ...
                                        <li>
                                            <button type="button" data-modal-target="delete-modal{{$ferry->id}}" data-modal-toggle="delete-modal{{$ferry->id}}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-red-400">
                        ...
                        @include('admin.ferries.crud.delete-ferry')

                        @include('admin.ferries.fares.fare')

                        @include('admin.ferries.crud.read-ferry')
                ...
                <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                    ...
                    <ul class="inline-flex items-stretch -space-x-px">
                        ...
                        @foreach (range($startPage, $endPage) as $page)
                            <li>
                                <a href="{{ $ferries->url($page) . (empty(request()->input('query')) ? '' : '&query=' . request()->input('query')) }}"
