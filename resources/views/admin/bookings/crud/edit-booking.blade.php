                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-lg py-2">
                    ...
                    <div class="px-4 py-2 mx-auto">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mb-3">
                                <div class="w-full">
                                    ...
                                    <select id="booking-status" name="booking-status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500">
                                        ...
                                        <option value="Pending" {{ old('booking-status', $booking->status) == 'Pending' ? 'selected' : '' }} class="text-yellow-600 dark:text-yellow-300">Pending</option>
                                        <option value="Canceled" {{ old('booking-status', $booking->status) == 'Canceled' ? 'selected' : '' }} class="text-red-600 dark:text-red-400">Canceled</option>
                                        <option value="Paid" {{ old('booking-status', $booking->status) == 'Paid' ? 'selected' : '' }} class="text-green-600 dark:text-green-400">Paid</option>
                                    </select>
                                </div>
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mb-3">
                                <div class="w-full">
                                    <label for="payment-status" class="block my-2 text-sm font-medium text-gray-900 dark:text-white">Payment Status<span class="text-red-600">*</span></label>
                                    <select id="payment-status" name="payment-status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500">
                                        <option value="" disabled>Choose a type</option>
                                        <option value="Pending" {{ old('payment-status', $booking->payment->payment_status) == 'Pending' ? 'selected' : '' }} class="text-yellow-600 dark:text-yellow-300">Pending</option>
                                        <option value="Canceled" {{ old('payment-status', $booking->payment->payment_status) == 'Canceled' ? 'selected' : '' }} class="text-red-600 dark:text-red-400">Canceled</option>
                                        <option value="Paid" {{ old('payment-status', $booking->payment->payment_status) == 'Paid' ? 'selected' : '' }} class="text-green-600 dark:text-green-400">Paid</option>
                                    </select>
                                </div>
                                <div class="w-full">
                                    <label for="payment-method" class="block my-2 text-sm font-medium text-gray-900 dark:text-white">Payment Method<span class="text-red-600">*</span></label>
