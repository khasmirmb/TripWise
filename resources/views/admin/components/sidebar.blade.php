  ...
  <ul class="space-y-2">
    ...
    <li>
      ...
      >
        ...
        @if (App\Models\Message::where('read', false)->count())
          
        <span
          class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-primary-800 bg-primary-100 dark:bg-primary-200 dark:text-primary-800"
        >
        {{ App\Models\Message::where('read', false)->count() }}
        </span>
        @endif
      </a>
    </li>
    <li>
      ...
      <ul id="dropdown-records" class="hidden py-2 space-y-2">
        <li>
          <a
            href="{{route('admin.record.payment')}}"
            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >Payments</a
          >
        </li>
        <li>
          <a
            href="{{route('admin.record.passenger')}}"
            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >Passengers</a
          >
        </li>
        <li>
          <a
            href="{{route('admin.record.contact')}}"
            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            >Contact Info</a
          >
        </li>
