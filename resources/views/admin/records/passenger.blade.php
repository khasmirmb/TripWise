            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-t-lg">
                      ...
                      <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                          <div class="flex items-center">
                            ...
                            <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Passenger</span>
                          </div>
                        </li>
                      </ol>
                    </nav>
                ...
                <div class="flex flex-col items-center justify-start p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                    <div class="w-full md:w-1/2">
                        <form action="{{route('admin.passenger.search')}}" method="GET" class="flex items-center">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <td class="w-4 p-4">
                                <div class="flex items-center">
                                    <div class="flex items-center">
                                        <div class="text-base font-semibold">{{ $passengers->firstItem() + $loop->index }}</div>
                                    </div>
                                </div>
                            </td>
            ...
            <div class="relative overflow-hidden bg-white rounded-b-lg dark:bg-gray-800">
                <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white">{{ $passengers->firstItem() }}-{{ $passengers->lastItem() }}</span> of <span class="font-semibold text-gray-900 dark:text-white">{{ $passengers->total() }}</span>
                    </span>
                    <ul class="inline-flex items-stretch -space-x-px">
                        ...
                        @foreach (range($startPage, $endPage) as $page)
                            <li>
                                <a href="{{ $passengers->url($page) . (empty(request()->input('query')) ? '' : '&query=' . request()->input('query')) }}"
