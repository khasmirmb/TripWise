<!-- Schedule Read Modal -->
<div id="schedule-read{{$schedule->id}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    @php
        use App\Models\Seat;

        $fares = $schedule->ferries->fares;
        $numberOfFares = count($fares);
    ...
    <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="w-full">
                    ...
                    <div class="mb-2 font-semibold leading-none text-gray-900 dark:text-white space-x-0 sm:space-x-2">Details</div>
                    ...
                    <div class="mb-2 font-semibold leading-none text-gray-900 dark:text-white space-x-0 sm:space-x-2">Fares</div>
                    <div class="w-full grid sm:grid-cols-{{$numberOfFares}} gap-4 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-3 sm:space-x-4">              
                        <button type="button" data-modal-toggle="schedule-read{{$schedule->id}}" class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-teal-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                            Done
                        </button>
                    </div>
                </div>
