          ...
          <div class="relative bg-white dark:bg-gray-800 rounded-t-lg">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      ...
                      <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Staffs</span>
                    </div>
                  </li>
                </ol>
              </nav>
            ...
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
              <div class="w-full md:w-1/2">
                <form action="{{route('admin.staff.search')}}" method="GET" class="flex items-center">
              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg">
                  ...
                  <tbody>
                      ...
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                          <td class="w-4 p-4">
                              <div class="flex items-center">
                                <div class="text-base font-semibold">{{ $staffs->firstItem() + $loop->index }}</div>
                              </div>
                          </td>
                          <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            ...
                            @endif
                            <div class="pl-3">
                              <div class="text-base font-semibold">{{ ucfirst($staff->firstname) . " ". ucfirst(substr($staff->middlename, 0, 1)) . " " . ucfirst($staff->lastname) }}</div>
                          ...
                          <td class="px-6 py-4">
                              <div class="flex items-center space-x-4 justify-center">
                                <a href="{{route('admin.user.edit', ['user' => $staff->id])}}" class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-teal-700 rounded-lg hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800">
                                ...
                                <button type="button" data-modal-target="staff-preview{{$staff->id}}" data-modal-toggle="staff-preview{{$staff->id}}" class="py-2 px-3 flex items-center text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-teal-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
