                            ...
                            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                                ...
                                <div class="w-full text-center">
                                    ...
                                    <div class="flex justify-center">
                                        @if ($user->image)
                                        <img src="{{asset('profile/' . $user->image)}}" class="rounded-full w-36 h-36 border-2">
                                        @else
