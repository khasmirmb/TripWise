        ...
        <div class="md:mx-10 p-4 mb-4">
            <div class="flex items-center">
                ...
                <div class="flex items-center text-white relative">
                    ...
                    <div class="absolute top-0 text-center mt-16 w-auto text-xs font-medium uppercase text-teal-600 hidden sm:block">Payment</div>
                </div>
                ...
                <div class="flex items-center text-gray-500 dark:text-white relative">
                    ...
                    <div class="absolute top-0 w-auto text-center mt-16 text-xs font-medium uppercase text-gray-500 dark:text-white hidden sm:block">Complete</div>
                </div>
            </div>
        </div>
    </div> 
