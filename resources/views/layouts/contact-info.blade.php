<div class="grid gap-4 sm:grid-cols-2 sm:gap-6 rounded-lg py-8 px-6 my-3 bg-gray-100 dark:bg-gray-700">
    <div class="w-full">
        ...
        <input type="text" name="contact-person" id="contact-person" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-600 focus:border-teal-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500" style="text-transform: capitalize;" placeholder="Full Name" value="{{old('contact-person')}}" required>
    ...
    <div class="w-full">
        ...
        <input type="confirm-email" name="confirm-email" id="confirm-email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-600 focus:border-teal-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-teal-500 dark:focus:border-teal-500" placeholder="name@email.com" value="{{old('confirm-email')}}" required>
        @error("confirm-email")
            <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
        @enderror
    </div>
