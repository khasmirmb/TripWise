        ...
        <div class="md:mx-10 p-4 mb-4">
            <div class="flex items-center">
                <div class="flex items-center text-teal-600 relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600 hidden sm:block">Schedule</div>
                </div>          
                ...
                <div class="flex items-center text-teal-600 relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600 hidden sm:block">Payment</div>
                </div>
                <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-teal-600"></div>
                <div class="flex items-center text-white relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600 hidden sm:block">Complete</div>
                </div>
            </div>
        </div>
    </div> 
