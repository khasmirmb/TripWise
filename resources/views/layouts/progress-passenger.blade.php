<section class="bg-slate-50 dark:bg-gray-900 border-b-2 border-gray-200 shadow">
    <div class="p-5">
        <div class="md:mx-10 p-4 mb-4">
            <div class="flex items-center">
                <div class="flex items-center text-teal-600 relative">
                    <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2  border-teal-600 dark:text-teal-600">
                    ...
                    <div class="absolute top-0 text-center mt-16 w-auto text-xs font-medium uppercase text-teal-600 hidden sm:block">Schedule</div>
                </div>          
                ...
                <div class="flex items-center text-white relative">
                    ...
                    <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-xs font-medium uppercase text-teal-600 hidden sm:block">Passenger Info</div>
                </div>
                ...
                <div class="flex items-center text-gray-500 dark:text-white relative">
                    ...
                    <div class="absolute top-0 text-center mt-16 w-auto text-xs font-medium uppercase text-gray-500 dark:text-white hidden sm:block">Payment</div>
                </div>
                <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-gray-300"></div>
                <div class="flex items-center text-gray-500 dark:text-white relative">
                    <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-gray-300">
                    ...
                    <div class="absolute top-0 text-center w-auto mt-16 text-xs font-medium uppercase text-gray-500 dark:text-white hidden sm:block">Complete</div>
                </div>
            </div>
        </div>
    </div> 
