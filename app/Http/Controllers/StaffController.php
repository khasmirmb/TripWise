...
class StaffController extends Controller
{
    ...
    public function scheduleSearch(Request $request)
    {
        ...
        return view('staff.schedules.schedule', compact('schedules', 'query'));
    }
    ...
    */
    public function staffBooking()
    {
        ...
        return view('staff.bookings.booking', compact('bookings'));
    }
    ...
    public function addBookingForm()
    {
        ...
        return view('staff.bookings.crud.add-booking', compact('schedules', 'ports'));
    }
    ...
    public function createBooking(Request $request)
    {
        ...
        return redirect()->route('staff.booking')->with('success', 'Booking created successfully');
    }
    ...
    public function editBookingForm($booking)
    {
        ...
        return view('staff.bookings.crud.edit-booking', compact('booking', 'schedules', 'fee', 'seats'));
    }
    ...
    public function updateBooking(Request $request, $bookingId)
    {
        ...
        return redirect()->route('staff.booking')->with('success', 'Booking updated successfully');
    }
    ...
    public function bookingSearch(Request $request)
    {
        ...
        return view('staff.bookings.booking', compact('bookings', 'query'));
    }
    ...
    */
    public function paymentIndex()
    {
        ...
        return view('staff.records.payment', compact('payments'));
    }
    ...
    */
    public function passengerIndex()
    {
        ...
        return view('staff.records.passenger', compact('passengers'));
    }
    ...
    */
    public function contactIndex()
    {
        ...
        return view('staff.records.contact', compact('contacts'));
    }
    ...
    public function paymentSearch(Request $request)
    {
        ...
        return view('staff.records.payment', compact('payments', 'query'));
    }
    ...
    public function passengerSearch(Request $request)
    {
        ...
        return view('staff.records.passenger', compact('passengers', 'query'));
    }
    ...
    public function contactSearch(Request $request)
    {
        ...
        return view('staff.records.contact', compact('contacts', 'query'));
    }
}
